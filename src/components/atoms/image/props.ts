...
interface ImagePropsType {
    src: string, // validate src is a string that represents the path to the image.
    alt: string, // validate alt is a string that represents the alternative text for the image.
    classes?: string, // validate classes is a string that represents the CSS classes that will be applied to the element.
    height?: number, // validate height is a number that represents the height of the image.
    width?: number, // validate width is a number that represents the width of the image.
